...
> 在原作者莫淇钦（上海科技大学马涵慧实验室）的基础上进行了代码重构、Bug 修复、遵循原项目许可开源。
> 主要改进见 [RELEASE_NOTES.md](RELEASE_NOTES.md)，原始出处见原仓库。
...
```
# 下载
git clone https://github.com/sweety924/NGS_Tools.git
...
根据以上操作，即可运行本程序的图形界面。图形界面操作按照图形提示即可。
